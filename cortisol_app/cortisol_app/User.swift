...
extension User: Equatable {
    static func == (lhs: User, rhs: User) -> Bool{
        return (lhs.getId == rhs.getId) && (lhs.getEmail == rhs.getEmail) && (lhs.getPassword == rhs.getPassword) && (lhs.getFirstName == rhs.getFirstName) && (lhs.getLastName == rhs.getLastName)
    }
}
